...
function($) {
	...
	Portlet.prototype.init = function() {
		// Panel closest
		var $this = this;
		$(document).on('click', this.$portletCloser,
		function(ev) {
			ev.preventDefault();
		...
		// Panel Reload
		$(document).on('click', this.$portletRefresher,
		function(ev) {
			ev.preventDefault();
			var $portlet = $(this).closest($this.$portletIdentifier);
...
function ajaxLoad(url, sethash) {
	var domain = window.location.protocol + '//' + window.location.host + '/easydp/';
	var $container = $('#div-container');
	var $loader = $('.preloader');
	
	//$loader.css('display', 'block');
	$container.load(domain + url, function() {
		//$loader.css('display', 'none');
		if (sethash) {
			window.location.hash = $.trim(url);
		}
	});
}
