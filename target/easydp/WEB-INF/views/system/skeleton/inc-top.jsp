		...
		<div class="topbar">
			...
			<div class="topbar-left">
				<div class="text-center">
					<a href="admin/index" class="logo"><i class="md md-terrain"></i>
						<span>EASYDP</span>
					</a>
				</div>
			</div>
			<!-- Button mobile view to collapse sidebar1 menu -->
				...
				<div class="container">
					<div>
						...
						<ul class="nav navbar-nav navbar-right pull-right">
							...
							<li class="hidden-xs">
								<a href="javascript:void(0);" class="right-bar-toggle waves-effect waves-light">
									<i class="md md-chat"></i>
								</a>
							</li>
							<li class="dropdown">
								<a href="javascript:void(0);" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
									<img src="resource/images/avatar-1.jpg" alt="user-img" class="img-circle"> 
								</a>
								<ul class="dropdown-menu">
									<li>
										<a href="javascript:void(0)">
											<i class="md md-face-unlock"></i> 资料
										</a>
									</li>
									<li>
										<a href="javascript:void(0)">
									...
									<li>
										<a href="javascript:void(0)">
											<i class="md md-settings-power"></i> 登出
										</a>
									</li>
								</ul>
							</li>
